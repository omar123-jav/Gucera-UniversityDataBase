...
<head runat="server">
    <title>GUCera - Issue Promocode</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Issue Promocode</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GUCeraConnectionString %>" SelectCommand="SELECT [code] FROM [Promocode]"></asp:SqlDataSource>
        <br />
        <asp:Button ID="Button1" runat="server" Text="Issue" OnClick="Button1_Click" BackColor="#99FFCC" BorderColor="#66FF99" BorderStyle="Ridge" BorderWidth="4px" Font-Bold="True" Font-Names="Algerian" ForeColor="#003300" />
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="Button3" runat="server" BackColor="#FFFF99" BorderColor="#FFFF66" BorderStyle="Ridge" BorderWidth="4px" Font-Bold="True" Font-Names="Algerian" ForeColor="#CCCC00" OnClick="Home_Click" Text="Home" />
    </form>
</body>
</html>
