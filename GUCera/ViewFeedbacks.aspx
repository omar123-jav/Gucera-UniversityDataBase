...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">View Feedbacks</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <p>
            <asp:Button ID="Button1" runat="server" Text="View" OnClick="Button1_Click" BackColor="Silver" BorderStyle="Double" />
        </p>
        <p>
