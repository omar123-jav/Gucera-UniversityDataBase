...
<head runat="server">
    <title>GUCera - Course List</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Available Courses</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <asp:Button ID="enrollButton" runat="server" Text="Enroll" OnClick="enrollButton_Click" BackColor="#99FFCC" BorderColor="#66FF99" BorderStyle="Ridge" BorderWidth="4px" Font-Bold="True" Font-Names="Algerian" ForeColor="#003300" />
        <br />
        <br />
