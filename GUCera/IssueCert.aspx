...
<head runat="server">
    <title>GUCera - Issue Certificate</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Issue Certificate</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <asp:Button ID="Button2" runat="server" Text="Click here to view Student IDs" OnClick="Button2_Click" />
        <p>
        ...
        <p>
        <asp:Button ID="Button1" runat="server" BackColor="Silver" BorderStyle="Solid" Text="Issue" Visible="false" OnClick="Button1_Click1" />
        </p>
        <p>
