<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View All Courses.aspx.cs" Inherits="GUCera.View_All_Courses" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GUCera - All Courses</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">All Courses</asp:Label>
