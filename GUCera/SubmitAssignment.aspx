...
<head runat="server">
    <title>GUCera - Submit Assignment</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Submit Assignment</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <br />
        <br />
        <asp:Button ID="SubmitAssButton" runat="server" OnClick="SubmitAssButton_Click" Text="Submit" BackColor="#99FFCC" BorderColor="#66FF99" BorderStyle="Ridge" BorderWidth="4px" Font-Bold="True" Font-Names="Algerian" ForeColor="#003300" />
        <br />
