<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewInstructor.aspx.cs" Inherits="GUCera.AddNewInstructor" %>
...
<head runat="server">
    <title>GUCera - Add Instructor</title>
    <style>
        body{
...
<body>
    ...
    <asp:Panel ID="Panel1" class="headerpanel" runat="server" Width="100%" Height="55px">
            <asp:Label runat="server" style="font-size:45px ;font-weight: bold; color:black; opacity: 1; -webkit-text-stroke: 1px white; margin-top:-10px">Add Instructor</asp:Label>
    ...
    <div style="margin:30px">
        ...
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" Text="The instructor's id  "></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" BackColor="#CCCCCC" BorderColor="Silver" BorderStyle="Ridge" BorderWidth="4px"></asp:TextBox>
        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Enter a valid instructor id" OnServerValidate="CustomValidator1_ServerValidate" ></asp:CustomValidator>
        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Must be a number" ControlToValidate="TextBox2" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
        <p>
